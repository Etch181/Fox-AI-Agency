  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fox-sidebar fixed inset-y-0 z-50 w-[min(86vw,320px)] shrink-0 overflow-y-auto border-slate-200 bg-slate-50 px-4 py-6 shadow-2xl transition-[translate] duration-300 dark:border-slate-800 dark:bg-slate-900 md:static md:z-auto md:w-64 md:shadow-none md:min-h-[calc(100vh-4rem)] ltr:border-r rtl:border-l`}>
