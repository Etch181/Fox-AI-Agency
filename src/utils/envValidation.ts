...
export const ENV_VAR_CATALOG: EnvVarClassification[] = [
  ...
  { name: "AGENTROUTER_API_KEY", required: false, scope: "universal", description: "AgentRouter API key" },
  { name: "AGENTROUTER_BASE_URL", required: false, scope: "universal", description: "AgentRouter OpenAI-compatible base URL" },
  { name: "AGENTROUTER_MODEL", required: false, scope: "universal", description: "AgentRouter primary model" },
