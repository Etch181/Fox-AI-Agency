...
export interface WorkspaceAgentRouting {
  enabledAgents: WorkspaceAgentId[];
  primaryAgent: WorkspaceAgentId;
  agentPriorities: Partial<Record<WorkspaceAgentId, number>>;
  routingMode: "rules" | "intent" | "hybrid";
...
export interface Workspace {
  ...
  agentRouting?: WorkspaceAgentRouting;
  ...
  aiProviderMode?: "openrouter" | "gemini" | "auto";
